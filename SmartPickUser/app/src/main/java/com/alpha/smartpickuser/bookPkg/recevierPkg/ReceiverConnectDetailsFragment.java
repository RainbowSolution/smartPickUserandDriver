package com.alpha.smartpickuser.bookPkg.recevierPkg;
...
public class ReceiverConnectDetailsFragment extends BottomSheetDialogFragment {

    public static final String TAG = "ActionBottomDialog";
    public static ReceiverConnectDetailsFragment newInstance() {
        return new ReceiverConnectDetailsFragment();
    }
    ...
    private void init(View view) {
        ...
        txt_title.setText("Receiver Contact");
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof ItemClickListenerReciverDetails) {
            mListener = (ItemClickListenerReciverDetails) context;
        } else {
