package com.alpha.smartpick.driver.notificationPkg;
...
import com.alpha.smartpick.driver.notificationPkg.adapterPkg.NotificationAdapter;
...
public class NotificationActivity extends AppCompatActivity implements NotificationAdapter.NotificationOnClickListener,View.OnClickListener {
    ...
    private String userId,vehicletype;
    ...
    private void init() {
        ...
        vehicletype = AppSession.getStringPreferences(NotificationActivity.this, Constants.VEHICLE_TYPE);
    ...
    private void ridehistory() {
        apiServices.notificaitonList(userId,vehicletype).enqueue(new Callback<GetNotificationListModel>() {
            @Override
