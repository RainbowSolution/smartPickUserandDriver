package com.alpha.smartpick.driver.historyDetailsPkg;
...
import com.alpha.smartpick.driver.passengerPkg.CustomAdapter;
import com.alpha.smartpick.driver.passengerPkg.LocationItem;
...
public class HistoryDetailsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private AppCompatTextView tvIdnumberId,text_date_id,textpriceId,textdistanceId,
            userNameId,reciver_id,txt_p_loc,txt_d_loc,stuff_type,status_id,userNumberId;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.viewpaymentdetailsId:
               /* Intent intent = new Intent(HistoryDetailsActivity.this, PaymentDetailsActivity.class);
